...
## Project Structure
    ...
    ├── testapiautoconnect_108780  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_108780`
...
2. Clone this repo and `cd testapiautoconnect_108780`
